      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="pb-3">
            <CardDescription>Receita Média (6 meses)</CardDescription>
            <CardTitle className="text-3xl text-success">R$ 5.233</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription>Despesa Média (6 meses)</CardDescription>
            <CardTitle className="text-3xl text-destructive">R$ 4.550</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription>Poupança Média (6 meses)</CardDescription>
            <CardTitle className="text-3xl text-accent">R$ 633</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-1 text-sm text-muted-foreground">
              <span>12.1% da receita média</span>
            </div>
          </CardContent>
        </Card>
      </div>
